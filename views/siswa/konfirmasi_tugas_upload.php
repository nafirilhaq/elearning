                ...
                <div class="panel panel-default">
                  <div class="panel-body">
                    <table class="table table-bordered">
                      ...
                      <tr><td>Berkas</td><td><?php if(empty($nuldata) || ($nuldata->list_jawaban)==NULL){ echo '<i>Belum ada berkas</i>';}else{?><a href="<?php echo base_url();?>siswa/download_tugas/<?php echo $jawaban; ?>"><?php echo $nuldata->list_jawaban; }?></a></td></tr>
                       <tr><td>Nilai</td><td><?php if(empty($nuldata) || ($nuldata->nilai)==0.00){ echo '<i>-</i>';}else{?><?php echo $nuldata->nilai; }?></td></tr>
                    </table>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-5">
                <div class="panel panel-default">
                  <div class="panel-body">
                    ...
                    <div id="btn_upload">Tugas/Ujian akan mulai dalam <div id="akan_mulai"></div></div>

                    <div class="callout callout-danger" id="waktu_" style="margin-top: 20px">
                      Sisa waktu mengikuti tugas/ujian <br>
