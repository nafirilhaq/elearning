          ...
          <div class="box">
            ...
            <div class="box-body">
              <section class="content">
                <div class="row">
                  <div class="col-md-3">
                    <a href="<?php echo base_url();?>siswa/kirim_pesan/baru" class="btn btn-primary btn-block margin-bottom">Tulis Pesan</a>
                    ...
                    <div class="box box-solid">
                      ...
                      <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                          <li class="active"><a href="<?php echo base_url();?>siswa/tampil_pesan/masuk"><i class="fa fa-inbox"></i> Pesan Masuk
                            <span class="label label-primary pull-right">12</span></a></li>
                          <li><a href="<?php echo base_url();?>siswa/tampil_pesan/keluar"><i class="fa fa-envelope-o"></i> Pesan Terkirim</a></li>
                        </ul>
                      </div>
                      <!-- /.box-body -->
                    </div>
                        ...
                        <table id="pesan_detail" class="table">
                           <thead>
                            ...
                            <tbody>
                              ...
                              ?>
                              <tr>
                                <td style='vertical-align:middle' width="20px"><?php echo $row['username'];?>
                                  <div>
                                ...
                                <td style='vertical-align:middle; background-color: #d9edf7;' width="120px">
                                  <div  class="pull-right" style="vertical-align: top">
                                    <span><a href="<?php echo base_url();?>siswa/hapus_pesan/satu/<?php echo $this->uri->segment(3); ?>/<?php echo $row['id'];?>" class="AlertaEliminarCliente fa fa-trash-o"></a></span>
                                  </div>
                                  <div>
                          ...
                          <div class="box box-primary">
                            ...
                            <form method="post" action="<?php echo base_url();?>siswa/kirim_pesan/balas/<?php echo $this->uri->segment(3); ?>">
