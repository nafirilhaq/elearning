          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="panel panel-default">
                <div class="panel-heading">Detail Materi &nbsp; <a href="<?php echo base_url();?>siswa/tampil_materi" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                   ...
                   <div style="width: 100%; display: flex; margin-top: 5px; align-items: center;">
                        ...
                        <div style="width: 10%;">
                          <span>
                            <a href="<?php echo base_url();?>siswa/download_materi/<?php echo $materi['file']; ?>" class="btn btn-app">
                              <i class="fa fa-download"></i> Download
                            </a>
                        </div>
                        <div style="width: 15%;">
                           <span><?php echo $materi['file']; ?></span>
                        </div>
                   </div>
                  <?php } ?>
                </div>
                ...
                <div class="box box-success">
                  ...
                  <div class="box-body chat" id="chat-box">
                    ...
                    <!-- chat item -->
                    <?php
                      foreach ($komentar->result_array() as $komentar) {
                    ?>
                  ...
                  <div class="box-footer">
                    <form method="post" action="<?php echo base_url();?>siswa/tambah_komentar">
