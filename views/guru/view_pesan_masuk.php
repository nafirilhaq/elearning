                    ...
                    <div class="box box-solid">
                      ...
                      <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                          <li class="active"><a href="<?php echo base_url();?>guru/tampil_pesan/masuk"><i class="fa fa-inbox"></i> Pesan Masuk
                            <?php if($hitung_pesan->num_rows()>0){?>
                            <span class="label label-primary pull-right"><?php echo $hitung_pesan->num_rows();?></span>
                            <?php } ?>
                          <li><a href="<?php echo base_url();?>guru/tampil_pesan/keluar"><i class="fa fa-envelope-o"></i> Pesan Terkirim</a></li>
                        </ul>
                      </div>
                      <!-- /.box-body -->
                    </div>
                              ...
                              <tr>
                                  ...
                                  <td style='vertical-align:middle; background-color: #d9edf7;' width="120px">
                                    <div  class="pull-right" style="vertical-align: top">
                                      <span><a href="<?php echo base_url();?>guru/hapus_pesan/masuk/<?php echo $row['sender_receiver_id'];?>" class="AlertaEliminarCliente fa fa-trash-o"></a></span>
                                    </div>
                                    <div>
