          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="panel panel-default">
                <div class="panel-heading">Tambah Tugas / Upload &nbsp; <a href="<?php echo base_url();?>index.php/guru/tampil_tugas" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post" action="<?php echo base_url();?>guru/simpan_tugas/upload">
