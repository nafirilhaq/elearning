          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="panel panel-default">
                <div class="panel-heading">Tambah Materi &nbsp; <a href="<?php echo base_url();?>index.php/guru/tampil_materi" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post" action="<?php echo base_url();?>index.php/guru/simpan_materi/tertulis">
