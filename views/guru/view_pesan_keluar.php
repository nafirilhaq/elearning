          ...
          <div class="box">
            ...
            <div class="box-body">
              <section class="content">
                <div class="row">
                  <div class="col-md-3">
                    <a href="<?php echo base_url();?>guru/kirim_pesan/baru" class="btn btn-primary btn-block margin-bottom">Kirim Pesan</a>
                    ...
                    <div class="box box-solid">
                      ...
                      <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                          <li><a href="<?php echo base_url();?>guru/tampil_pesan/masuk"><i class="fa fa-inbox"></i> Pesan Masuk
                            <?php if($hitung_pesan->num_rows()>0){?>
                            <span class="label label-primary pull-right"><?php echo $hitung_pesan->num_rows();?></span>
                            <?php } ?>
                          <li class="active"><a href="<?php echo base_url();?>guru/tampil_pesan/keluar"><i class="fa fa-envelope-o"></i> Pesan Terkirim</a></li>
                        </ul>
                      </div>
                      <!-- /.box-body -->
                    </div>
                        ...
                        <table id="pesan_all" class="table">
                           <thead>
                            ...
                            <tbody>
                              ...
                              ?>
                              <tr>
                                  <td style='vertical-align:middle' width="20px"><a href="<?php echo base_url();?>guru/tampil_pesan_detail/<?php echo $row['id_login']; ?>" style="color: black"><?php if($row['opened']==0){?><b><?php echo $row['username'];?></b>
                                    <div>
                                  ...
                                  <td style='vertical-align:middle; background-color: #d9edf7;' width="120px">
                                    <div  class="pull-right" style="vertical-align: top">
                                      <span><a href="<?php echo base_url();?>guru/hapus_pesan/keluar/<?php echo $row['sender_receiver_id'];?>" class="AlertaEliminarCliente fa fa-trash-o"></a></span>
                                    </div>
                                    <div>
                                      <span><a href="<?php echo base_url();?>guru/tampil_pesan_detail/<?php echo $row['id_login']; ?>" style="color: black"><?php if($row['opened']==0){?><b><?php echo $row['content'];?></b><?php }else { echo $row['content']; }?></a></span>
                                    </div>
                                  </td>
