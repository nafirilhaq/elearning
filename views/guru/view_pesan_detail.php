          ...
          <div class="box">
            ...
            <div class="box-body">
              <section class="content">
                <div class="row">
                  <div class="col-md-3">
                    <a href="<?php echo base_url();?>guru/kirim_pesan/baru" class="btn btn-primary btn-block margin-bottom">Tulis Pesan</a>
                      ...
                      <div class="box-body no-padding">
                        <table id="pesan_detail" class="table">
                              ...
                              <tr>
                                ...
                                <td style='vertical-align:middle; background-color: #d9edf7;' width="120px">
                                  <div  class="pull-right" style="vertical-align: top">
                                    <span><a href="<?php echo base_url();?>guru/hapus_pesan/satu/<?php echo $this->uri->segment(3); ?>/<?php echo $row['id'];?>" class="AlertaEliminarCliente fa fa-trash-o"></a></span>
                                  </div>
                                  <div>
                          ...
                          <div class="box box-primary">
                            ...
                            <form method="post" action="<?php echo base_url();?>guru/kirim_pesan/balas/<?php echo $this->uri->segment(3); ?>">
