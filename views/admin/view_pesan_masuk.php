                        ...
                        <table id="pesan_all" class="table">
                           <thead>
                            ...
                            <tbody>
                              ...
                              ?>
                              <tr>
                                  <td style='vertical-align:middle' width="20px"><a href="<?php echo base_url();?>admin/tampil_pesan_detail/<?php echo $row['id_login']; ?>" style="color: black">
                                    <?php 
                                    $count=0;
                                    foreach ($hitung_pesan_detail->result_array() as $hitung) {
                                      if($hitung['sender_receiver_id']==$row['sender_receiver_id']){
                                        $count++;
                                      } 
                                    } 
                                    if($count>0){?>
                                    <span class="label label-primary pull-right"><?php echo $count;?></span>
                                    <?php} if($row['opened']==0){?><b><?php echo $row['nama'];?></b>
                                    <div>
                                  ...
                                  <td style='vertical-align:middle; background-color: #d9edf7;' width="120px">
                                    <div  class="pull-right" style="vertical-align: top">
                                      <span><a href="<?php echo base_url();?>admin/hapus_pesan/masuk/<?php echo $row['sender_receiver_id'];?>" class="AlertaEliminarCliente fa fa-trash-o"></a></span>
                                    </div>
                                    <div>
