          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="profil">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url();?>admin/update_profile_siswa">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style='text-align:center;vertical-align:middle'>
                          <a href="<?php echo base_url(); ?>admin/rekap_nilai/<?php echo $data['id_siswa']; ?>/<?php echo $data['kelas']; ?>/<?php echo $mapel['id_mapel']; ?>">
              ...
              <div class="tab-pane" id="akun">
                ...
                ?>
                <form class="form-horizontal" method="post" action="<?php echo base_url();?>admin/update_akun_siswa">
                  <input type="hidden" id="id_siswa" name="id_siswa" value="<?php echo $data['id_siswa'] ?>">
        ...
        <div id="modal_edit" class="modal fade" role="dialog">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form class="form-horizontal" method="post" action="<?php echo base_url();?>admin/simpan_foto/<?php echo $data['id_siswa']; ?>" enctype="multipart/form-data">
                  ...
                  ?>
                    ...
                    <table class="table table-striped">
                      <tbody>
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="<?php echo base_url();?>admin/hapus_foto/<?php echo $data['id_siswa']; ?>/<?php echo $data['foto'];?>/<?php echo $data['jk'];?>" class="pull-right btn btn-default AlertaEliminarCliente"><i class="fa fa-trash-o"></i> Hapus foto</a>
