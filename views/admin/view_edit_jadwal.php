            ...
            <div class="box-body">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  ?>
                    <form method="post" action="<?php echo base_url();?>admin/update_jadwal/<?php echo $kls->id_kelas; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_guru" class="form-control" required>
                                ...
                                ?>
                                  <option value="<?php echo $guru['id_guru'] ?>" <?php if($guru['id_guru'] == $edit['id_guru']) echo 'selected';?>><?php echo $guru['nama_guru'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
